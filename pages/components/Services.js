...
{services.map(service=>{
    return <div data-aos="zoom-in-right" className="box2  w-1/1 relative hover:scale-90 bg-white  transition-all duration-700 max-[570px]:w-1/1  h-[240px] shadow-lg shadow-[#D8D8D8] rounded-[10px]">
